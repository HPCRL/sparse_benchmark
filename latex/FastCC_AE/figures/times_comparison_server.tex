...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \addplot[draw=none, OrangeBarStyle, x=tensor, y=speedup]   table {data/speedup_best_server.txt};
    %\addplot[draw=none, fill=green!30, x=op, y=perf]   table {data/orkut_CUDA.txt};
    
    \addplot[draw=none, BlueBarStyle, x=tensor, y=speedup]   table {data/speedup_model_server.txt};
  ...
  \caption{FROSTT comparison on server machine with 64 threads}
